    ...
    <nav class="page_nav">
        <ul class="mainmenu">
            <li class="lavel-1 with--drop slide--megamenu">
                <n-link to="/">
                   <span style="color:#463d9c">Home</span>
                </n-link>
            ...
            <li class="lavel-1 with--drop slide--megamenu">
                <n-link to="/about-us-01">
                    <span style="color:#463d9c">Pages</span>
                </n-link>
                <ul class="mega__width--fullscreen">
                    <div class="container">
                        <div class="mega__list">
            ...
            <li class="lavel-1 with--drop slide--megamenu">
                <n-link to="/portfolio/portfolio-grid-boxed">
                    <span style="color:#463d9c">Portfolio</span>
                </n-link>
                <ul class="mega__width--fullscreen">
                    <div class="container">
                        <div class="mega__list">
            ...
            <li class="lavel-1 with--drop slide--megamenu">
                <n-link to="">
                    <span style="color:#463d9c">Elements</span>
                </n-link>
                <ul class="mega__width--fullscreen">
                    <div class="container">
                        <div class="mega__list">
            ...
            <li class="lavel-1 with--drop slide--megamenu">
                <n-link to="/blog/blog-creative">
                    <span style="color:#463d9c">Blog</span>
                </n-link>
                <ul class="mega__width--fullscreen">
                    <div class="container">
                        <div class="mega__list">
